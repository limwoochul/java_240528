...
public class ComparisonOperatorEx01 {
	...
	public static void main(String[] args) {
		...
		System.out.println("str1 == str3 : " + (str1==str3)); //str3은 리터럴이 아닌 방법(객체)으로 저장하기 때문에 주소가 다름
		System.out.println("str2 == str3 : " + (str2==str3)); //str3은 리터럴이 아닌 방법(객체)으로 저장하기 때문에 주소가 다름
