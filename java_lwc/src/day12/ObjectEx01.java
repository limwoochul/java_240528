...
public class ObjectEx01 {
	...
	public static void main(String[] args) throws CloneNotSupportedException {
		...
		System.out.println("std1 == std2 : " + (std1 == std3));
		System.out.println("std1 == std2 : " + (std1 == std4));
		//equals를 이용하여 비교
		System.out.println("--------------------------------------");
		System.out.println("std1 == std2 : " + (std1.equals(std2)));
		System.out.println("std1 == std2 : " + (std1.equals(std3)));
		System.out.println("std1 == std2 : " + (std1.equals(std4)));
		...
		System.out.println("std1.equls(std5) : " + std1.equals(std5));
