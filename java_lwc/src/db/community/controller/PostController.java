...
import db.community.pagenation.PageMaker;
...
public class PostController {
	...
	public void deleteCommunity() {
		...
		//서비스에게 커뮤니티명을 주고 삭제하라고 요청후 성공하면 성공하면 커뮤니티 삭제 성공!
		PrintController.printBar();
	...
	public void printPostList(Criteria cri) {
		...
		try {
			...
			PrintController.printBar();
			//위에서 예외가 발생하면 잘못된 커뮤니티 번호입니다라고 출력하고 종료			
	...
	public PostVO printPostDetail() {
		...
		//서비스에게 조회하려는 게시글의 조회수를 증가시키라고 요청
	...
	public boolean updatePost(int po_num) {
		...
		String content = scan.nextLine();
		//게시글 번호, 새 제목, 내용을 이용하여 게시글VO를 생성
	...
	public void printCommentList(PostVO post) {
		...
		//있으면 댓글 리스트에서 하나씩 꺼내 출력.(CommentVO에 toString을 오버라이딩)
