...
//jsp form태그에 enctype을 설정하지 않고 @MultipartConfig를 추가하면 인식을 못함
//jsp form태그에 enctype을 설정하고 @MultipartConfig를 추가하면 인식을 못함
@MultipartConfig(
	maxFileSize = 1024 * 1024 * 10, //10Mb -> 바이트 단위이기 때문
	maxRequestSize = 1024 * 1024 * 10 * 3, //전체 합쳐서 30Mb
