...
<div class="container">
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" value="<fmt:formatDate value="${post.po_date}" pattern="yyyy-MM-dd HH:mm"/>">
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="form-control" style="min-height : 300px">${post.po_content}</div>
	</div>
	<hr>
	<div>
		<h3>댓글 목록</h3>
