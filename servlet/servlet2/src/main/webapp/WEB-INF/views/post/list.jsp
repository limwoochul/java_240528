...
<div class="container" style="min-height: calc(100vh - 240px)">
	<h1 class="mt-3 mb-3">${co.co_name} 커뮤니티 게시글 목록</h1>
	<!-- 
	4. 검색 기능 구현
	- jsp 검색창 추가 : type, search
	- mapper에 타입에 따른 검색 쿼리를 수정
	- 페이지네이션 링크 수정
	 -->
	<form action="">
	...
	<div class="clearfix">
		<a href="<c:url value="/post/insert?co_num=${co.co_num}"/>" class="btn btn-outline-success float-right">게시글 등록</a>
