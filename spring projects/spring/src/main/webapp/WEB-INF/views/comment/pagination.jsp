...
<div class="comment-pagination">
	<ul class="pagination justify-content-center">
		<c:if test="${pm.prev}">
			<li class="page-item" data-page="${pm.startPage - 1}"><a class="page-link" href="javascript:void(0);">Previous</a></li>
		</c:if>
		...
		<c:if test="${pm.next}">
			<li class="page-item" data-page="${pm.endPage + 1}"><a class="page-link" href="javascript:void(0);">Next</a></li>
		</c:if>
	</ul>
</div>
